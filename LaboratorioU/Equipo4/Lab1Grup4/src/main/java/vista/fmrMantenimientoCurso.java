 ...
 * @author visitante
 */
public class fmrMantenimientoCurso extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsCurso> listaCursos = curso.getListadoCursos();
        tablaCursos.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaCursos.size(); i++) {
            dato[0] = Integer.toString(listaCursos.get(i).getCodigoCurso());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsCurso curso = new clsCurso();
        curso.setCodigoCurso(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        curso.setEstatusCurso(txtContrasena.getText());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        curso.setCodigoCurso(Integer.parseInt(txtbuscado.getText()));        
        curso = curso.getBuscarInformacionCursoPorcodigo(curso);
        System.out.println("Curso retornado:" + curso);        
        txtNombre.setText(curso.getNombreCurso());
        txtContrasena.setText(curso.getEstatusCurso());
