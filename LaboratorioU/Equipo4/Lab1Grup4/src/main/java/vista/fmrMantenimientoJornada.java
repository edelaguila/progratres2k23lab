 ...
 * @author visitante
 */
public class fmrMantenimientoJornada extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsJornada> listaCursos = jornada.getListadoJornadas();
        tablaCursos.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaCursos.size(); i++) {
            dato[0] = Integer.toString(listaCursos.get(i).getCodigoJornada());
            dato[1] = listaCursos.get(i).getNombreJornada();
            dato[2] = listaCursos.get(i).getEstatusJornada();
            modelo.addRow(dato);
        }       
    }

    public fmrMantenimientoJornada() {
        initComponents();
        llenadoDeTablas();
        llenadoDeCombos();
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsJornada jornada = new clsJornada();
        jornada.setCodigoJornada(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsJornada jornada = new clsJornada();
        jornada.setNombreJornada(txtNombre.getText());
        jornada.setEstatusJornada(txtContrasena.getText());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        jornada.setCodigoJornada(Integer.parseInt(txtbuscado.getText()));        
        jornada = jornada.getBuscarInformacionJornadaPorcodigo(jornada);
        System.out.println("Curso retornado:" + jornada);        
        txtNombre.setText(jornada.getNombreJornada());
        txtContrasena.setText(jornada.getEstatusJornada());
