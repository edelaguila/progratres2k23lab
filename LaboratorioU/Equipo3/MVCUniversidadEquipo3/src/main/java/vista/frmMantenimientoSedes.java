...
public class frmMantenimientoSedes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsSedes usuario = new clsSedes();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsSedes> listaUsuarios = usuario.getListadoSedes();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaUsuarios.size(); i++) {
            dato[0] = (listaUsuarios.get(i).getCodigoSede());
            dato[1] = listaUsuarios.get(i).getNombreSede();
            dato[2] = listaUsuarios.get(i).getEstatusSede();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsSedes usuario = new clsSedes();
        usuario.setCodigoSede((txtbuscado.getText()));
        registrosBorrados=usuario.setBorrarSede(usuario);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsSedes usuario = new clsSedes();
        usuario.setCodigoSede(txtCodigo.getText());
        usuario.setNombreSede(txtNombre.getText());
        usuario.setEstatusSede(txtContrasena.getText());
        usuario.setIngresarSede(usuario);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        usuario.setCodigoSede((txtbuscado.getText()));        
        usuario = usuario.getBuscarInformacionSedePorId(usuario);
        System.out.println("Sede retornada:" + usuario);    
        txtCodigo.setText(usuario.getCodigoSede());
        txtNombre.setText(usuario.getNombreSede());
        txtContrasena.setText(usuario.getEstatusSede());
...
//        // TODO add your handling code here:
        ...
        usuario.setNombreSede(txtNombre.getText());
        usuario.setEstatusSede(txtContrasena.getText());
        usuario.setModificarSede(usuario);
