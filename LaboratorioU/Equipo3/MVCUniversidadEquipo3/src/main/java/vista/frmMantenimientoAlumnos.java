...
public class frmMantenimientoAlumnos extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsAlumnos> listaAlum = alumnos.getListadoAlum();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[6];
        for (int i = 0; i < listaAlum.size(); i++) {
            dato[0] = listaAlum.get(i).getCarnetAlumnos();
            dato[1] = listaAlum.get(i).getNombreAlumnos();
            dato[2] = listaAlum.get(i).getDireccionAlumnos();
            dato[3] = listaAlum.get(i).getTelefonoAlumnos();
            dato[4] = listaAlum.get(i).getEmailAlumnos();
            dato[5] = listaAlum.get(i).getEstatusAlumnos();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsAlumnos alumnos = new clsAlumnos();
        alumnos.setCarnetAlumnos(txtCarnet.getText());
        ...
        alumnos.setIngresarAlumnos(alumnos);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        txtEmail.setText(alumnos.getEmailAlumnos());
        txtEstatus.setText(alumnos.getEstatusAlumnos());
