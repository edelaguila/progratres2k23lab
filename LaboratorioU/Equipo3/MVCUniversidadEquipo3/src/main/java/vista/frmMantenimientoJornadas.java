...
public class frmMantenimientoJornadas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsJornadas usuario = new clsJornadas();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsJornadas> listaUsuarios = usuario.getListadoJornadas();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaUsuarios.size(); i++) {
            dato[0] = (listaUsuarios.get(i).getCodigoJornada());
            dato[1] = listaUsuarios.get(i).getNombreJornada();
            dato[2] = listaUsuarios.get(i).getEstatusJornada();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsJornadas usuario = new clsJornadas();
        usuario.setCodigoJornada((txtbuscado.getText()));
        registrosBorrados=usuario.setBorrarJornada(usuario);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsJornadas usuario = new clsJornadas();
        usuario.setCodigoJornada(txtCodigo.getText());
        usuario.setNombreJornada(txtNombre.getText());
        usuario.setEstatusJornada(txtContrasena.getText());
        usuario.setIngresarJornada(usuario);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        usuario.setCodigoJornada((txtbuscado.getText()));        
        usuario = usuario.getBuscarInformacionJornadaPorId(usuario);
        System.out.println("Jornada retornada:" + usuario);  
        txtCodigo.setText(usuario.getCodigoJornada());
        txtNombre.setText(usuario.getNombreJornada());
        txtContrasena.setText(usuario.getEstatusJornada());
...
//        // TODO add your handling code here:
        ...
        usuario.setNombreJornada(txtNombre.getText());
        usuario.setEstatusJornada(txtContrasena.getText());
        usuario.setModificarJornada(usuario);
