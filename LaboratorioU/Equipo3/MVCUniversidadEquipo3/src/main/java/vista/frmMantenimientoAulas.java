...
public class frmMantenimientoAulas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsAulas> listaAul = aulas.getListadoAul();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaAul.size(); i++) {
            dato[0] = listaAul.get(i).getCodigoAulas();
            dato[1] = listaAul.get(i).getNombreAulas();
            dato[2] = listaAul.get(i).getEstatusAulas();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        registrosBorrados=aulas.setBorrarAulas(aulas);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsAulas aulas = new clsAulas();
        aulas.setCodigoAulas(txtCodigo.getText());
        aulas.setNombreAulas(txtNombre.getText());
        aulas.setEstatusAulas(txtContrasena.getText());
        aulas.setIngresarAulas(aulas);
