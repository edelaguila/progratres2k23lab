...
public class daoSecciones {
    ...
    private static final String SQL_SELECT_NOMBRE = "codigo_seccion, nombre_seccion, estatus_seccion FROM secciones WHERE nombre_seccion = ?";
    ...
    public int actualizaSecciones(clsSecciones seccion) {
        ...
        try {
            ...
            stmt.setString(3, seccion.getCodigoSeccion());
    ...
    public clsSecciones consultaSeccionesPorNombre(clsSecciones seccion) {
        ...
        try {
            ...
            rs = stmt.executeQuery();
            while (rs.next()) {
                String id = rs.getString("codigo_seccion");
                String nombre = rs.getString("nombre_seccion");
                String estatus = rs.getString("estatus_seccion");

                //usuario = new clsUsuario();
                seccion.setCodigoSeccion(id);
                seccion.setNombreSeccion(nombre);
                seccion.setEstatusSeccion(estatus);
    ...
    public clsSecciones consultaSeccionesPorId(clsSecciones seccion) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
